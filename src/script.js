...
function handleScroll() {
    var scrollIconTop = scrollIconTopElement;
    var scrollIconBottom = scrollIconBottomElement;
    if(messages.scrollTop === 0){
        scrollIconTop.style.display = "none";
    }
    else if(messages.scrollHeight - messages.scrollTop === messages.clientHeight){
